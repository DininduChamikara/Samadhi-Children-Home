                    ...
                    <div class="panel panel-default"><!--panel panel-default starts-->
                        ...
                        <div class="panel-heading"><!--panel-heading starts-->
                            ...
                            <h3 class="panel-title">
                                ...
                                <i class="fa fa-money fa-fw"></i>Add Donars
                        ...
                        <div class="panel-body"><!--panel-body starts-->
                            ...
                            <form id="insert_form" class="form-horizontal" method="POST" ><!-- form-horizantal starts-->
                                ...
                                <div class="form-group"><!--form-group starts-->
                                    ...
                                    <label class="col-md-3 control-label">Donar Name</label>
                                    ...
                                    <div class="form-group" ><!-- form-group Starts -->
                                        ...
                                        <label class="col-md-3 control-label" ></label>
                                             ...
                                             <div class="col-md-6" >
                                                 ...
                                                 <button type="button"  class="btn btn-primary form-control" name="edit1" id="edit1" style="display: none;" data-toggle="modal">Add Donation</button>
                                        <button type="button" class="btn btn-primary form-control" name="edit2" id="edit2" style="display: none;" data-toggle="modal" data-target="#Item_Modal">Add Donation</button>
                                        <button type="button" class="btn btn-primary form-control" name="edit3" id="edit3" style="display: none;" data-toggle="modal" data-target="#Both_Modal">Add Donation</button>
                ...
                <div class="modal-body">  
                    ...
                    <div class="table-responsive" ><!-- table-responsive Starts -->
                       ...
                       <form method="post" id="cashForm_both">  
                          ...
                          <input type="submit" name="insert" id="insert_both" value="Insert" class="btn btn-success" />  
                     </form>  
        ...
        $.ajax({          
                ...
                $(document).on('click', '#btn_add', function() {
                    ...
                    $.ajax({
                        url: "insertItems.php",
                        method: "POST",
                        data: {id: itemid, description: description, qty: qty},
                        dataType: "text",
                        success: function(data)
                        {
                            swal(data);
